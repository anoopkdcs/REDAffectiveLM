...
#export csv to identify the index of documents
df = pd.DataFrame(x_val)
df.to_csv("/content/drive/MyDrive/6_quanlitative_evaluation/models/x_val.csv", index=True)
...
def visualize_attention(Sid):
    ...
    '''
    X_te = x_val_padded #x_train_padded #x_test_padded #Assign Train or Test to visualize 
    ...
    print("Original Emotion Label:"+ str(y_val[idx]))
    
    print("Original News Snippet:\n" + x_val_original[idx])
    print("Original Emotion Label:"+ str(y_val_original[idx]))
