...
class Attention(Layer): #Layer keras.layers.Layer
...
history = xlnet.fit(x=[x_train_tokens,x_train_padded], y=y_train, validation_data=([x_val_tokens,x_val_padded],y_val), epochs=800, batch_size=64, callbacks=checkpointer)
